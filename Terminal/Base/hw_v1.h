...
// DEBUG        调试信息输出口      USART1(115200,n,8,1)
// XFS5152      TTS语音合成模块     USART2(9600,n,8,1)
// RJMU101      加解密安全芯片      USART3[暂时未用](115200,n,8,1)
// I2411E       蓝牙wifi模块        USART3(115200,n,8,1)
// M35          GSM/GPRS模块        UART4(115200,n,8,1)
// ATG336H      中芯微GPS模块       UART5(9600,n,8,1)
...
// M35引脚定义
#define M35_PWR	                GPIO_Pin_8 //硬件开/关机
#define M35_PWR_PORT	        GPIOC
#define M35_STATUS              GPIO_Pin_9 //模块状态
